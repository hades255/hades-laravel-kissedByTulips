        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <button type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white"><i class="fa fa-plus-circle"></i> {{isset($account) && ($account->pk_account) ? 'Edit account' : 'Create New Account'}}</button>
                </div>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content br-n pn">
                                    <div id="navpills-1" class="tab-pane active">
                                      <div class="row">
                                        <form class="form-horizontal mt-4" method="post" action="/superadmin/account/edit/submit">
                                          @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="address" class="form-control" value="{{isset($account) && ($account->address)?$account->address:''}}">
                                            </div>
                                          </div>
                                            <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="address_1">Ste#</label>
                                                <input type="text" name="address_1" class="form-control" value="{{isset($account) && ($account->address_1)?$account->address_1:''}}" maxlength="10">
                                            </div>
                                           </div>
                                           </div>
                                           <div class="row">
                                             <div class="col-md-4">
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" name="city" class="form-control" value="{{isset($account) && ($account->city)?$account->city:''}}">
                                              </div>
                                            </div>
                                          <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="zip">Zip</label>
                                                <input type="text" name="zip" class="form-control" value="{{isset($account) && ($account->zip)?$account->zip:''}}">
                                            </div>
                                          </div>
                                          <div class="col-md-4">
                                         <div class="form-group">
                                      ...
                                      <div class="form-group">
                                          <label class="form-label">Active</label>
                                              ...
                                              <input type="radio" name="active" value="0" {{ isset($account) && ($account->active=="0")? "checked" : "" }} class="form-check-input" style="margin-left: 20px;">
                                                            ...
                                                            @foreach($getUsers as $getUser)
                                                              <tr>
                                                                  ...
                                                                  <td style="text-align:center;">
                                                                    ...
                                                                    <a class="btn btn-danger text-white" href="/superadmin/account/users/delete/{{$getUser->pk_users}}">Delete</a>
                                                                  </td>
                                                              </tr>
                                                              @endforeach
                                                          </tbody>
