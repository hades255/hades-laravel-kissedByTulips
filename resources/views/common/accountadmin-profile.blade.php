                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content br-n pn">
                                    <div id="navpills-1" class="tab-pane active">
                                        <div class="row">
                                          <form class="form-horizontal mt-4 " method="post" action="/accountadmin/account/users/profile/update">
                                            @csrf
                                           <div class="form-group">
                                                <label for="role">Role</label>
                                                @if(isset($user) && ($user->pk_roles == 2))
                                                <input type="text" name="role" class="form-control" value="Account-Admin" readonly>
                                                @endif
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <a href="/accountadmin"><input class="btn btn-primary" type="button" value="Cancel"></a>
                                            <a href="/accountadmin/account/users/profile/reset/{{isset($user) && ($user->pk_users)?$user->pk_users:''}}"><input class="btn btn-primary" type="button" value="{{isset($user) && ($user->pk_users)?'Reset Password':''}}"></a>
