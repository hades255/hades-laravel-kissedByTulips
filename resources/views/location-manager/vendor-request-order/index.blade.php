                ...
                <div class="col-md-7 align-self-center text-end">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb justify-content-end">
                            ...
                            <li class="breadcrumb-item active"><a href="/locationmanager/vendor-order-request">Vendor Order
                                    Request</a></li>
                        </ol>
                        <a href="/locationmanager/vendor-order-request/add" style="margin-top:-34px;"> <button type="button"
                                            ...
                                            @foreach ($vendorOrders as $vendorOrder)
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;">
                                                        <a
                                                            href="/locationmanager/vendor-order-request/edit/{{ $vendorOrder->pk_purchase_order }}"><button
                                                        ...
                                                        <form
                                                            action="{{ route('locationmanager.vendor-order-request.delete', [$vendorOrder->pk_purchase_order]) }}"
                                                            method="get"
...
<script>
    function goLink(id){
        window.location.href = `/locationmanager/vendor-order-request/view/${id}`;
    }
</script>
