        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <a href="/accountadmin/vendors/add"> <button type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white"><i
                                    ...
                                    <tr>
                                      <td onclick="window.location='{{ route('accountadmin.vendors.edit', ['id' => $vendor->pk_vendors]) }}'">{{$vendor->vendor_name}}</td>
                                        <td style="text-align:center;">
                                         ...
                                         <a href="/accountadmin/vendors/delete/{{$vendor->pk_vendors}}"><button class="btn btn-danger text-white">Delete</button></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
