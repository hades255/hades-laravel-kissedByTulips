        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <button type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white" style="margin-top:-34px;"><i class="fa fa-plus-circle"></i>{{ isset($SizeArrangement) && ($SizeArrangement->pk_size_arrangement) ? 'Edit Size Arrangement':'Create New Size Arrangement'}} </button>
                </div>
            </div>
        </div>
        <div class="row">
