            ...
            <div class="col-md-4" style="">
                <div class="row" id="content-div">
                    ...
                    <div class="sp-quantity" style="margin-top: 92px;margin-left: 94px;">
                        ...
                        <div class="sp-input">
                            <input type="text" class="quntity-input" name="quantity" id="quantity" max="100"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select col-8 category-cls " name="arrangementType" id="arrangementType"
                            ...
                            @if (!empty($arrangementTypes))
                                @foreach ($arrangementTypes as $arrangementType)
                                    <option value="{{ $arrangementType->pk_arrangement_type }}"
                                        data-price="{{ number_format($arrangementType->price, 2, '.', '') }}">
                                        {{ $arrangementType->arrangement_type }}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
            ...
            <div class="col-md-12">
                <div class="btn-group">
                    <a href="{{ route('accountadmin.sales.floral-arrangement') }}"
                        class="btn btn-info d-none d-lg-block m-l-15 text-white" style="margin-top: -34px;">
                        Continue Shopping
                    </a>
                    <a href="{{ route('accountadmin.sales.create') }}"
                        class="btn btn-info d-none d-lg-block m-l-15 text-white ml-3" style="margin-top: -34px;">
                        Go to sale page
                    </a>
                </div>
            </div>
        ...
        $(".subsciptionType").click(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("span#status").html(
                        '<div class="alert alert-success">Floral arrangement adding done successfully</div>'
                        );
                    location.reload();
                }
            });
