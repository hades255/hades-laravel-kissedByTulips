...
@section('content')
    <div class="page-wrapper">
        <div class="container-fluid">
            <form class="vendorRequestForm" method="post" action="/accountadmin/vendor-request-order/update"
                    ...
                    <div class="col-md-7 align-self-center text-end">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <button type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white"
                                    style="margin-top: -34px;">Edit Purchase Order
                            </button>
                        </div>
                    </div>
                    <ul class="nav nav-tabs customtab" role="tablist" id="myTab">
                        <li class="nav-item active"><a
                                ...
                                data-bs-toggle="tab" href="#vendor-request-order" role="tab" aria-selected="true"><span
                                    class="hidden-sm-up"></span> <span class="hidden-xs-down">Purchase Order</span></a>
                        </li>
                                                    ...
                                                    <div style="margin-left: 550px;">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" name="delivery_date_request"
                                                                   ...
                                                                   value="{{ $vendorOrder->delivery_date_request }}"
                                                                   required>
                                                                ...
                                                                @if ($locations)
                                                                    @foreach ($locations as $item)
                                                                        <option value="{{ $item->pk_locations }}"
                                                                                @if ($vendorOrder->pk_locations == $item->pk_locations) selected @endif>
                                                                            {{ $item->location_name }}</option>
                                                                    @endforeach
                                                                @endif
                                                                <option value="other"
                                                                        @if ($vendorOrder->pk_locations == 'other') selected @endif>
                                                                    Other
                                                                </option>
                                                            </select>
                                                            @error('pk_locations')
                                                        ...
                                                        <div id="address-section"
                                                             style=" display: @if($vendorOrder->pk_locations == 'other') block @else none @endif ">
                                                            <div class="form-group">
                                        ...
                                        <div class="tab-content br-n pn">
                                            <div id="navpills-1" class="tab-pane active">
                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="form-group mx-2">
                                                        ...
                                                        <select name="pk_products"
                                                            ...
                                                            <option value="other"
                                                                    @if ($item->pk_products == 'other') selected @endif>
                                                                Other
                                                            </option>
                                                        </select>
                                                        @error('pk_products')
                                                ...
                                                <div class="text-center" id="save-button-section"
                                                     @if(!count($vendorOrder->items)) style="display: none;" @endif>
                                                    <a href="/accountadmin/vendor-request-order"><input
                                                            class="btn btn-primary" type="button"
                                                            value="Cancel"></a>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.tempItemRowEditBtn', function (e) {
                ...
                // check item name is in select option or not
                if ($(".pk_products option[data-name='" + item_name + "']").length) {
                    $(".pk_products option[data-name='" + item_name + "']").prop("selected", true);
                } else {
                    $(".pk_products option[value='other']").prop("selected", true);
                    $('#temp_item_name').val(item_name);
                    $('#temp_name_section').show();
                }
