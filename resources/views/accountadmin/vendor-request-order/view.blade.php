                ...
                <div class="col-md-7 align-self-center text-end">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb justify-content-end">
                            ...
                            <li class="breadcrumb-item active"><a href="/accountadmin/vendor-request-order">Vendor Order
                                    Request</a></li>
                        </ol>
                        <a href="/accountadmin/vendor-request-order/add" style="margin-top:-34px;"> <button type="button"
                                ...
                                <table class="display nowrap table table-hover table-striped border" cellspacing="0"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ Helper::formatDate($vendorOrder->delivery_date_request) }}</td>
