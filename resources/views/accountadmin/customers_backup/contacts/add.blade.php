                        ...
                        <div class="row">
                           <div class="col-md-6">
                             <div class="form-group">
                                ...
                                <input type="text" name="address" id="address" class="form-control" value = "{{isset($customer_contact) && ($customer_contact->address) ? $customer_contact->address : old('address')}}">
                             </div>
                           </div>
                           <div class="col-md-6">
                             <div class="form-group">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                             <div class="form-group">
                                ...
                                <input type="text" name="city" id="city" class="form-control" value ="{{isset($customer_contact) && ($customer->city) ? $customer_contact->city : old('city')}}">
                             </div>
                           </div>
                           <div class="col-md-4">
                                <div class="form-group">
