   ...
   <div class="row page-titles">
      ...
      <div class="col-md-7 align-self-center text-end">
         <div class="d-flex justify-content-end align-items-center">
            ...
            <button type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white"><i class="fa fa-plus-circle"></i> {{isset($customer) && ($customer->pk_customers) ? 'Edit Customer' : 'Create New Customer'}}</button>
         </div>
      </div>
   </div>
   <div class="row">
      <div class="col-md-12">
         <div class="card">
            <div class="card-body p-b-0">
               <h4 class="card-title">{{isset($customer) && ($customer->pk_customers) ? 'Edit Business Customer'.' '. $customer->customer_name : 'Create New Business Customer'}} </h4>
            </div>
            <!-- Nav tabs -->
                                      ...
                                      <div class="row">
                                         <div class="col-md-6">
                                           <div class="form-group">
                                              ...
                                              <input type="text" id="address" name="address" class="form-control" value = "{{isset($customer) && ($customer->address) ? $customer->address : old('address')}}">
                                           </div>
                                         </div>
                                         <div class="col-md-6">
                                           <div class="form-group">
                                    ...
                                    <form action="/accountadmin/customers/comments/store" method="post">
                                      @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="contact_name" value="{{auth()->user()->first_name}} {{auth()->user()->last_name}}" readonly>
                                        </div>
                                    ...
                                    <table id="example23"
                                        ...
                                        <tbody>
                                          ...
                                          @foreach ($comments as $comment)
                                           <tr>
                                              <td>{{$comment->created_at->format('m/d/Y')}} Created by {{auth()->user()->first_name}} {{auth()->user()->last_name}}</td>
