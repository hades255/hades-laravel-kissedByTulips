      ...
      <div class="col-md-12">
         <div class="card">
            <div class="card-body p-b-0">
               <h4 class="card-title">{{isset($customer) && ($customer->pk_customers) ? 'Edit Customer'.' '. $customer->customer_name:'Create New Customer'}}</h4>
            </div>
            <!-- Nav tabs -->
                                      ...
                                      <div class="row">
                                         <div class="col-md-6">
                                           <div class="form-group">
                                              ...
                                              <input type="text" name="address" class="form-control" id="address" value ="{{isset($customer) && ($customer->address) ? $customer->address : old('address')}}">
                                           </div>
                                         </div>
                                         <div class="col-md-6">
                                           <div class="form-group">
                                    ...
                                    <form action="/accountadmin/customers/comments/store" method="post">
                                      @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="contact_name" readonly value="{{auth()->user()->first_name}} {{auth()->user()->last_name}}">
                                        </div>
                                          <a href="/accountadmin/customers/back"><input class="btn btn-primary" type="button" value="Cancel"></a>
