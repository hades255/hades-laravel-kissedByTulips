                        ...
                        <div class="card-body">
                            <table class="table table-hover table-bordered">
                                ...
                                <tr>
                                    <th>Billing Zip</th>
                                    @if($sale->order)
                                     <td>{{ $sale->order->zip }}</td>
                                     @endif
                                </tr>

                                @if( isset($sale->order) && ($sale->order->billaddress ==  $sale->order->address))
                                 <input type="checkbox" checked value="Same as Billing Address">
                                @else
                                  <tr>
                                    <th>Shipping Address</th>
                                    @if($sale->order)
                                     <td>{{ $sale->order->billaddress }}</td>
                                    @endif
                                </tr>
                                ...
                                <tr>
                                    ...
                                    @if($sale->order)
                                     <td>{{ $sale->order->billstate_name }}</td>
                                     @endif
                                </tr>
                                ...
                                <tr>
                                    ...
                                    @if($sale->order)
                                     <td>{{ $sale->order->billcountry_name }}</td>
                                     @endif
                                </tr>
